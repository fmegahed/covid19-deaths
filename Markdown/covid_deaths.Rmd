...
# Printing the static version of the map
knitr::include_graphics('../Figures/rplTheme1Map.png')
```
...
# Printing the static version of the map
knitr::include_graphics('../Figures/rplTheme2Map.png')
```
...
# Printing the static version of the map
knitr::include_graphics('../Figures/rplTheme3Map.png')
```
...
# Printing the static version of the map
knitr::include_graphics('../Figures/rplTheme4Map.png')
```
...
# Printing the static version of the map
knitr::include_graphics('../Figures/percRepVotesMap.png')
```
...
# Printing the static version of the map
knitr::include_graphics('../Figures/cdcMap.png')
```
...
knitr::include_graphics('../Figures/governorsMap.png')
```
